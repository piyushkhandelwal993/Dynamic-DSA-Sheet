...
export type FunctionDriverStrategy =
  ...
  | "string-merge-alternately"
  | "string-separate-even-odd"
  | "string-reverse-words-line"
  ...
  | "dp-stock-cooldown"
  | "dp-knight-probability"
  | "dp-stock-two-transactions"
  | "dp-grid-budget-reachability"
  | "dp-unique-paths"
  | "dp-min-path-sum"
  | "dp-subset-sum"
  | "dp-knapsack-01"
...
export interface AnalysisResult {
  ...
  signals: {
    ...
    usesPreorderTraversal: boolean;
    usesInorderTraversal: boolean;
    usesPostorderTraversal: boolean;
    usesQueueTraversal: boolean;
    usesLeftViewPattern: boolean;
    usesRightViewPattern: boolean;
    usesTreeHeight: boolean;
    usesTreeDiameter: boolean;
    usesBalancedTreeCheck: boolean;
    usesBstLogic: boolean;
    usesBstSearch: boolean;
    usesBstMutation: boolean;
    usesBstDeleteHandling: boolean;
