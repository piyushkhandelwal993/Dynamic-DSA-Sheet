...
ipcMain.handle("desktop:get-license-status", async () => getDesktopApi().getDesktopLicenseOverview());
ipcMain.handle("desktop:activate-license-code", async (_event, email, code) => getDesktopApi().activateDesktopLicenseCode(email, code));
