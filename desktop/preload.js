...
contextBridge.exposeInMainWorld("dsaDesktop", {
  ...
  startProblem: (problemId, language) => ipcRenderer.invoke("desktop:start-problem", problemId, language),
  loadWorkspace: (problemId, language) => ipcRenderer.invoke("desktop:load-workspace", problemId, language),
  saveWorkspace: (problemId, code, language) => ipcRenderer.invoke("desktop:save-workspace", problemId, code, language),
  runProblem: (problemId, code, options) => ipcRenderer.invoke("desktop:run-problem", problemId, code, options),
  submitProblem: (problemId, code, language) => ipcRenderer.invoke("desktop:submit-problem", problemId, code, language),
